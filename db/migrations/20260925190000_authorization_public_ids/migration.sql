...
CREATE UNIQUE INDEX `Permission_publicId_key`
    ON `Permission`(`publicId`);
CREATE UNIQUE INDEX `Role_publicId_key`
    ON `Role`(`publicId`);
CREATE UNIQUE INDEX `RolePermission_publicId_key`
    ON `RolePermission`(`publicId`);

...
const MainContent = () => {
    if (!useAuthorization("EditUserTagsPage", Permission.admin_general)) {
        throw new Error(`unauthorized`);
    }
    return <>
        <SettingMarkdown settingName="EditUserTagsPage_markdown"></SettingMarkdown>
...
export default EditUserTagsPage;

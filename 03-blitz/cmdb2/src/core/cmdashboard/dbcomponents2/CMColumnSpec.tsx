...
export abstract class CMFieldSpecBase<DBModel, WhereInput, FieldType> {
    ...
    ValidateAndParse = (val: FieldType): ValidateAndParseResult<FieldType> => {
        if (!this.zodSchema) {
    ...
    renderForNewDialog?: (params: RenderForNewItemDialogArgs<DBModel, FieldType>) => React.ReactElement; // will render as a child of <FormControl>
    ...
    isEqual = (lhsSanitizedFieldValue: FieldType, rhsSanitizedFieldValue: FieldType) => {
    ...
    abstract getQuickFilterWhereClause: (query: string) => WhereInput | boolean;
};

export class CMTableSpecRequiredValues<DBModel, WhereInput> {
    fields: CMFieldSpecBase<DBModel, WhereInput, any>[];
    devName: string;
    CreateMutation: any;
...
export class CMTableSpec<DBModel, WhereInput> extends CMTableSpecRequiredValues<DBModel, WhereInput> {// implements ITableSpec<DBModel> {
    ...
    constructor(reqValues: CMTableSpecRequiredValues<DBModel, WhereInput>, overrides?: Partial<CMTableSpec<DBModel, WhereInput>>) {
        super();

...
import { InsertFromStringParams } from "./CMForeignSingleField";
...
export interface ManyToManyFieldArgs<ForeignModel> {
    member: string,
    fkidMember: string,
    label: string,
    cellWidth: number,
...
export interface ManyToManyFieldInputProps<DBModel, ForeignModel> {
    field: ManyToManyField<DBModel, ForeignModel>;
    value: ForeignModel | null;
    onChange: (value: ForeignModel | null) => void;
};

// general use "edit cell" for foreign single values
export const ManyToManyFieldInput = <DBModel, ForeignModel,>(props: ManyToManyFieldInputProps<DBModel, ForeignModel>) => {
...
export abstract class ManyToManyField<DBModel, ForeignModel> extends CMFieldSpecBase<DBModel> {

    args: ManyToManyFieldArgs<ForeignModel>;

    constructor(args: ManyToManyFieldArgs<ForeignModel>) {
        super();
        this.args = args;

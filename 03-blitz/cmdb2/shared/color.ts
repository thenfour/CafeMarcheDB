...
const gPaletteMap: ColorPaletteEntry[] = [
    CreatePaletteEntry("black", "black", "#aaaaaa", "black", "#666666", "#888888", false, "#666666", "#cccccc", false, "#000000", "#b3b5c9", true, "#000000", "#d8d9e4", true, "#666666", "#888888", false, "#666666", "#cccccc", false, "#6a7095", "#8e92af", false, "#6a7095", "#eeeeee", false),
    CreatePaletteEntry("dark_gray", "dark_gray", "#cccccc", "black", "#888888", "#aaaaaa", false, "#888888", "#eeeeee", false, "#474a61", "#d8d9e4", false, "#444444", "#d7dbff", false, "#888888", "#aaaaaa", false, "#888888", "#eeeeee", false, "#8e92af", "#b3b5c9", false, "#8e92af", "#eeeeee", false),
    CreatePaletteEntry("gray", "gray", "#dddddd", "black", "#aaaaaa", "#cccccc", false, "#aaaaaa", "#ffffff", false, "#8e92af", "#ffffff", false, "#8e92af", "#ffffff", false, "#aaaaaa", "#cccccc", false, "#aaaaaa", "#ffffff", false, "#b3b5c9", "#d8d9e4", false, "#b3b5c9", "#ffffff", false),
    ...
    CreatePaletteEntry("pink", "pink", "#ffcfc2", "#ff9f88", "#cccccc", "#eeeeee", false, "#cccccc", "#ffffff", false, "#ff9f88", "#eeeeee", false, "#ff9f88", "#ffffff", false, "#cccccc", "#eeeeee", false, "#cccccc", "#ffffff", false, "#ffcfc2", "#ff9f88", false, "#ffcfc2", "#e62b19", false),
    CreatePaletteEntry("red", "red", "#e62b19", "#e62b19", "#aaaaaa", "#cccccc", false, "#aaaaaa", "#eeeeee", false, "#e62b19", "#ffcfc2", false, "#e62b19", "#ffffff", false, "#aaaaaa", "#cccccc", false, "#aaaaaa", "#eeeeee", false, "#ff9f88", "#ffcfc2", false, "#ff9f88", "#ffffff", false),
    ...
    CreatePaletteEntry("light_pink", "light_pink", "#ff9f88", "#f76d50", "#cccccc", "#eeeeee", false, "#cccccc", "#ffffff", false, "#ffcfc2", "#e62b19", false, "#ffcfc2", "#e62b19", false, "#cccccc", "#eeeeee", false, "#cccccc", "#ffffff", false, "#ffcfc2", "#ff9f88", false, "#ffcfc2", "#e62b19", false),
    CreatePaletteEntry("light_red", "light_red", "#f76d50", "#f76d50", "#aaaaaa", "#cccccc", false, "#aaaaaa", "#eeeeee", false, "#ffcfc2", "#e62b19", false, "#ffcfc2", "#e62b19", false, "#aaaaaa", "#cccccc", false, "#aaaaaa", "#eeeeee", false, "#ffcfc2", "#ff9f88", false, "#ffcfc2", "#e62b19", false),
    CreatePaletteEntry("light_maroon", "light_maroon", "#df6e86", "#cc3361", "#888888", "#aaaaaa", false, "#888888", "#ffffff", false, "#f9cfd5", "#cc3361", false, "#f9cfd5", "#cc3361", false, "#888888", "#aaaaaa", false, "#888888", "#ffffff", false, "#f9cfd5", "#ee9fac", false, "#f9cfd5", "#cc3361", false),
    CreatePaletteEntry("light_brown", "light_brown", "#cea772", "#cea772", "#888888", "#aaaaaa", false, "#888888", "#eeeeee", false, "#f1e1cf", "#ba8b45", false, "#f1e1cf", "#ba8b45", false, "#888888", "#aaaaaa", false, "#888888", "#eeeeee", false, "#f1e1cf", "#e1c3a0", false, "#f1e1cf", "#ba8b45", false),
    CreatePaletteEntry("light_orange", "light_orange", "#ff9a51", "#ff9a51", "#aaaaaa", "#cccccc", false, "#aaaaaa", "#eeeeee", false, "#ffddc4", "#ff7700", false, "#ffddc4", "#ff7700", false, "#aaaaaa", "#cccccc", false, "#aaaaaa", "#eeeeee", false, "#ffddc4", "#ffbc8a", false, "#ffddc4", "#ff7700", false),
    CreatePaletteEntry("light_gold", "light_gold", "#ffcc00", "#ffcc00", "#cccccc", "#dddddd", false, "#cccccc", "#ffffff", false, "#fff2cb", "#786117", false, "#fff2cb", "#786117", false, "#cccccc", "#dddddd", false, "#cccccc", "#ffffff", false, "#fff2cb", "#ffd85f", false, "#fff2cb", "#786117", false),
    CreatePaletteEntry("light_citron", "light_citron", "#eeff00", "#adb918", "#cccccc", "#dddddd", false, "#cccccc", "#ffffff", false, "#fdff9d", "#71771b", false, "#fdff9d", "#71771b", false, "#cccccc", "#dddddd", false, "#cccccc", "#ffffff", false, "#fdff9d", "#cccccc", false, "#fdff9d", "#71771b", false),
    CreatePaletteEntry("light_olive", "light_olive", "#ccd98f", "#afc657", "#aaaaaa", "#cccccc", false, "#aaaaaa", "#eeeeee", false, "#e6ecc7", "#6a8311", false, "#e6ecc7", "#6a8311", false, "#aaaaaa", "#cccccc", false, "#aaaaaa", "#eeeeee", false, "#e6ecc7", "#ccd98f", false, "#e6ecc7", "#6a8311", false),
    CreatePaletteEntry("light_green", "light_green", "#a0db8e", "#69c755", "#888888", "#aaaaaa", false, "#888888", "#eeeeee", false, "#d0edc6", "#198310", false, "#d0edc6", "#198310", false, "#888888", "#aaaaaa", false, "#888888", "#eeeeee", false, "#d0edc6", "#a0db8e", false, "#d0edc6", "#198310", false),
    CreatePaletteEntry("light_teal", "light_teal", "#9edacd", "#68c7b5", "#aaaaaa", "#cccccc", false, "#aaaaaa", "#ffffff", false, "#cfede6", "#198374", false, "#cfede6", "#198374", false, "#aaaaaa", "#cccccc", false, "#aaaaaa", "#ffffff", false, "#cfede6", "#9edacd", false, "#cfede6", "#198374", false),
    CreatePaletteEntry("light_blue", "light_blue", "#abb8ff", "#7696ff", "#aaaaaa", "#cccccc", false, "#aaaaaa", "#eeeeee", false, "#d7dbff", "#0077ff", false, "#d7dbff", "#0077ff", false, "#aaaaaa", "#cccccc", false, "#aaaaaa", "#eeeeee", false, "#d7dbff", "#abb8ff", false, "#d7dbff", "#0077ff", false),
    CreatePaletteEntry("light_purple", "light_purple", "#eaccf8", "#d399f0", "#888888", "#aaaaaa", false, "#888888", "#eeeeee", false, "#eaccf8", "#b865e7", false, "#eaccf8", "#b865e7", false, "#888888", "#aaaaaa", false, "#888888", "#eeeeee", false, "#eaccf8", "#d399f0", false, "#eaccf8", "#b865e7", false),
    ...
    CreatePaletteEntry("attendance_no", "attendance_no", "#e62b19", "#e62b19", "#aaaaaa", "#cccccc", false, "#aaaaaa", "#eeeeee", false, "#e62b19", "#ffcfc2", false, "#e62b19", "#ffffff", false, "#aaaaaa", "#cccccc", false, "#aaaaaa", "#eeeeee", false, "#ff9f88", "#ffcfc2", false, "#ff9f88", "#ffffff", false),
    CreatePaletteEntry("attendance_no_maybe", "attendance_no_maybe", "#ff7700", "#ff7700", "#aaaaaa", "#cccccc", false, "#aaaaaa", "#eeeeee", false, "#ff7700", "#ffddc4", false, "#ff7700", "#ffffff", false, "#aaaaaa", "#cccccc", false, "#aaaaaa", "#eeeeee", false, "#ffbc8a", "#ffddc4", false, "#ffbc8a", "#ffffff", false),
    CreatePaletteEntry("attendance_yes_maybe", "attendance_yes_maybe", "#ffcc00", "#ba9415", "#cccccc", "#dddddd", false, "#cccccc", "#ffffff", false, "#ffcc00", "#786117", false, "#ffcc00", "#000000", false, "#cccccc", "#dddddd", false, "#cccccc", "#ffffff", false, "#ffe596", "#ffcc00", false, "#ffe596", "#000000", false),

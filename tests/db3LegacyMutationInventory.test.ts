...
const legacyGridSites: Record<string, LegacyWriterCategory> = {
    ...
    "src/pages/backstage/editFileTags.tsx": "lookup-grid",
    "src/pages/backstage/editFiles.tsx": "ordinary-grid",
    "src/pages/backstage/editFrontpageGalleryItems.tsx": "ordinary-grid",
    "src/pages/backstage/editSongCreditTypes.tsx": "lookup-grid",
    "src/pages/backstage/editSongCredits.tsx": "nested-row",
    "src/pages/backstage/editSongs.tsx": "ordinary-grid",
    "src/pages/backstage/editSongTags.tsx": "lookup-grid",
    "src/pages/backstage/editUserTags.tsx": "lookup-grid",
    "src/pages/backstage/editWikiPageTags.tsx": "lookup-grid",
    "src/pages/backstage/instrumentTags.tsx": "lookup-grid",
    "src/pages/backstage/instruments.tsx": "ordinary-grid",
    "src/pages/backstage/permissions.tsx": "ordinary-grid",
    "src/pages/backstage/roles.tsx": "ordinary-grid",
    "src/pages/backstage/settings.tsx": "ordinary-grid",

...
const calendarDates = getStoredAllDayCalendarRange(new Date("2026-07-10T00:00Z"), 86_400_000)
...
process.stdout.write(JSON.stringify({
  ...
  calendarDates,
  encodedDate: calendarDateToUtcDate(calendarDates.startDate).toISOString(),
}))

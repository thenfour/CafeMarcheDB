...
async function collect() {
  ...
  return {
    ...
    ongoingLabel: CalcRelativeTiming(new Date("2026-07-09T23:00:00Z"), event, { viewerTimeZone: Intl.DateTimeFormat().resolvedOptions().timeZone, bandTimeZone: "Europe/Brussels", locale: "en-US" }),
    endedLabel: CalcRelativeTiming(new Date("2026-07-10T23:00:00Z"), event, { viewerTimeZone: Intl.DateTimeFormat().resolvedOptions().timeZone, bandTimeZone: "Europe/Brussels", locale: "en-US" }),

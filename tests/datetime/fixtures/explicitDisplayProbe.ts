...
console.log(JSON.stringify({
  ...
  translations: formatEventDateRangeTranslations(timed, { viewerTimeZone: "Europe/Brussels", bandTimeZone: "Europe/Brussels" }),
  allDayTranslations: formatEventDateRangeTranslations(allDay, { viewerTimeZone: "Asia/Tokyo", bandTimeZone: "Europe/Brussels" }),

// NOTE: actualy, clientcore is quite different from the other files in terms of dependency tree.
// so import this file ONLY if you need the client basic fields stuff

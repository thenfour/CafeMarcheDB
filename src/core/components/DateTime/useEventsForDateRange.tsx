import { DateTimeRange, getLocalCalendarWindow, gMillisecondsPerHour } from "@/shared/time";
...
export const useEventsForDateRange = (dateRange: DateTimeRange | null) => {
    ...
    const filterSpec = React.useMemo(() => {
        ...
        return {
            refreshSerial: 1,
            quickFilter: "",
            calendarWindow: getLocalCalendarWindow(startDate, endDateExclusive),
    ...
    }, [dateRange, now, dashboardContext.eventStatus]);
            ...
            try {
                const transformed = enrichedEvents.flatMap(event => event.segments
                    ...
                    .map(segment => ({
                        ...
                        dateRange: getEventSegmentDateTimeRange(segment),
                    })));
    ...
    }, [enrichedEvents, filterSpec, dashboardContext.eventStatus]);

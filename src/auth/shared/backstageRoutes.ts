...
const routes = [
    ...
    { key: "profile", pattern: "/backstage/profile", caption: "Your Profile", permission: Permission.login },
    ...
    { key: "instrument", pattern: "/backstage/instrument/[slug]", caption: "Instrument", permission: Permission.login },

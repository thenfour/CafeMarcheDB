...
const routes = [
    ...
    { key: "editUserTags", pattern: "/backstage/editUserTags", caption: "User Tags", permission: Permission.admin_users },
    ...
    { key: "eventImport", pattern: "/backstage/eventImport", caption: "Import events", permission: Permission.admin_events },
